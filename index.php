...
<script type="module">
    ...
    function init() {
        ...
        var mainBuilding = new THREE.Group();
        var base = new THREE.Mesh(new THREE.BoxGeometry(building.Width, building.Height, building.Depth), materialGate);
        base.position.set(0, building.Height/2, 0);
        mainBuilding.add(base.clone());
        ...
        mainBuilding.add(towerBuilding.clone());
        towerBuilding.position.set(-building.Width / 2, 0, building.Width / 2);
        mainBuilding.add(towerBuilding.clone());
        towerBuilding.position.set(-building.Width / 2, 0, -building.Width / 2);
        mainBuilding.add(towerBuilding.clone());
        towerBuilding.position.set(building.Width / 2, 0, -building.Width / 2);
        mainBuilding.add(towerBuilding.clone());
        var mainBuildingTop = new THREE.Mesh(new THREE.BoxGeometry(building.Width/1.4, building.Height/1.8, building.Depth/1.4), materialGate);
        mainBuildingTop.position.set(0, building.Height/2 + (building.Width/1.4)/2, 0);
        mainBuilding.add(mainBuildingTop.clone());
        ...
        mainBuilding.add(mainBuildingRoof.clone());
        var buildingDoor = new THREE.Mesh(new THREE.PlaneGeometry(Gate.DoorWidth, Gate.DoorHeight), materialPorte);
        buildingDoor.position.set(0, Gate.DoorHeight / 2, building.Depth/2 + 1);
        mainBuilding.add(buildingDoor.clone());
        var buildingWindow = new THREE.Mesh(new THREE.BoxGeometry(House.WindowWidth, House.WindowHeight, House.WindowDepth), materialPorte);
        buildingWindow.position.set(25,building.Height + (building.Height/1.8) / 2, (building.Depth/1.4)/2);
        mainBuilding.add(buildingWindow.clone());
        buildingWindow.position.set(-25,building.Height + (building.Height/1.8) / 2, (building.Depth/1.4)/2);
        mainBuilding.add(buildingWindow.clone());
        buildingWindow.position.set(25,building.Height + (building.Height/1.8) / 2, -(building.Depth/1.4)/2);
        mainBuilding.add(buildingWindow.clone());
        ...
        buildingWindow.rotateY(Math.radians(90));
        mainBuilding.add(buildingWindow.clone());
        buildingWindow.position.set((building.Width/1.4)/2,building.Height + (building.Height/1.8) / 2, -25);
        mainBuilding.add(buildingWindow.clone());
        buildingWindow.position.set(-(building.Width/1.4)/2,building.Height + (building.Height/1.8) / 2, 25);
